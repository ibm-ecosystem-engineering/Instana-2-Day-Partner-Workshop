...
In this lab we will smart alert for the robot shop application. Instana provides the ability to define alert conditions for various scenarios from within the context of application perspective.At the end of this lab, you will be able to create a smart alert for calls with slow response time.
